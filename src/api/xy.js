...
export const getXyMemberPlans = () => unwrap(request.get('/xy/members/plans'))
...
export const getXyReservationPauses = () => unwrap(request.get('/xy/reservation-pauses'))
export const saveXyReservationPause = (data) => unwrap(request.post('/xy/reservation-pauses', data))
export const resumeXyReservationPause = (batchNo) => unwrap(request.delete(`/xy/reservation-pauses/${encodeURIComponent(batchNo)}`))
